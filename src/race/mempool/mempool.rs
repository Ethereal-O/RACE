...
impl MemPool {
    ...
    pub fn increase_global_depth(&mut self) -> bool {
        self.dir.atomic_add_global_depth(1)
    }

    pub fn try_lock_entry(&mut self, index: usize, old_data: u64) -> Result<u64, u64> {
        self.dir.try_lock_entry(index, old_data, 1)
    }

    pub fn unlock_entry(&mut self, index: usize, old_data: u64) -> Result<u64, u64> {
